package com.agesun.mybatis.util2;
...
//        boolean flag = false;
        ...
        commands.add(mencoderPath);
        commands.add(upFilePath);
        commands.add("-oac");
        commands.add("mp3lame");
        commands.add("-lameopts");
        commands.add("preset=64");
        commands.add("-lavcopts");
        commands.add("acodec=mp3:abitrate=64");
        commands.add("-ovc");
        commands.add("xvid");
        commands.add("-xvidencopts");
        commands.add("bitrate=600");
        commands.add("-of");
        commands.add("avi");
        commands.add("-o");
        commands.add(codcAviPath);
        try {
            // 预处理进程
